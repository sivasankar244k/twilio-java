...
public class SharedCostReader extends Reader<SharedCost> {
     ...
     */
    @Override
    public Page<SharedCost> nextPage(final Page<SharedCost> page,
     ...
     */
    @Override
    public Page<SharedCost> previousPage(final Page<SharedCost> page,
                                         final TwilioRestClient client) {
        Request request = new Request(
            HttpMethod.GET,
    ...
    /**
     * Generate a Page of SharedCost Resources for a given request.
     *
     * @param client TwilioRestClient with which to make the request
